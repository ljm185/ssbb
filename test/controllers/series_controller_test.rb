...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post series_index_url, params: { series: { genre: @series.genre, name: @series.name, year_of_debut: @series.year_of_debut } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { genre: @series.genre, name: @series.name, year_of_debut: @series.year_of_debut } }
