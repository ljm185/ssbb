...
class FightersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fighter" do
    assert_difference('Fighter.count') do
      post fighters_url, params: { fighter: { catchphrase: @fighter.catchphrase, clone: @fighter.clone, name: @fighter.name, series_id: @fighter.series_id } }
    end
  ...
  test "should update fighter" do
    patch fighter_url(@fighter), params: { fighter: { catchphrase: @fighter.catchphrase, clone: @fighter.clone, name: @fighter.name, series_id: @fighter.series_id } }
